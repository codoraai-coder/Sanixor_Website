      ...
      <section className="hero relative min-h-[90vh]">
        ...
        >
          ...
          <p className="hero-sub max-w-3xl text-center mt-4 text-lg md:text-xl leading-relaxed text-muted-foreground">
            Deploy enterprise-grade AI agents without managing infrastructure, development
            environments, or complex AI architectures.
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  Businesses often lack the technical expertise and resources required to build,
                  deploy, and maintain AI agents internally.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  AaaS provides ready-to-deploy intelligent agents capable of automating workflows,
                  handling conversations, and orchestrating business operations instantly.
                </p>
              </motion.div>
            </div>
          </div>
