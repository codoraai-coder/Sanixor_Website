      ...
      <section className="hero relative min-h-[90vh]">
        ...
        >
          ...
          <p className="hero-sub max-w-3xl text-center mt-4 text-lg md:text-xl leading-relaxed text-muted-foreground">
            Tailor-made AI automation systems designed specifically around an organization's
            workflows, operational processes, and business objectives.
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  Generic AI tools often fail to address industry-specific requirements, proprietary
                  data structures, and unique organizational workflows.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  Sanixor AI designs, develops, and deploys custom AI agents and automation
                  ecosystems aligned to each client's exact business requirements.
                </p>
              </motion.div>
            </div>
          </div>
              ...
              <div className="relative h-[400px] rounded-3xl overflow-hidden border border-border/50 glow-ring order-2 md:order-1">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-background via-background/80 to-transparent p-10 flex flex-col justify-center">
                  ...
                  <p className="text-xl text-gray-300 font-light leading-relaxed">
                    Delivering AI systems that fit business operations precisely, maximizing
                    automation effectiveness and ROI.
                  </p>
                </div>
              </div>
