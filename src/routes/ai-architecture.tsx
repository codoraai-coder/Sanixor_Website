      ...
      <section className="hero relative min-h-[90vh]">
        ...
        >
          ...
          <p className="hero-sub max-w-3xl text-center mt-4 text-lg md:text-xl leading-relaxed text-muted-foreground">
            Strategic system design and topology planning to build secure, compliant, and
            cost-optimized AI infrastructure for the enterprise.
          </p>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  Scaling AI systems often leads to skyrocketing inference costs, security
                  vulnerabilities, and compliance risks if not architected correctly from day one.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  We design enterprise-grade AI topologies with built-in redundancy, strict
                  compliance guardrails, and optimized resource allocation for long-term
                  scalability.
                </p>
              </motion.div>
            </div>
