  ...
  const timelineSteps = [
    {
      step: 1,
      title: "Register",
      description: "Complete the registration form and secure your seat.",
    },
    {
      step: 2,
      title: "Confirmation",
      description: "Receive confirmation and event details via email.",
    },
    {
      step: 3,
      title: "Participate",
      ...
      <main className="mx-auto max-w-[1500px] px-4 py-20 md:py-32 md:px-6 flex flex-col gap-24 md:gap-32">
            ...
            {[
              {
                ...
                title: "Act I — Deep Dive Workshops",
                desc: "Expert lectures on multi-agent collaboration, MCP Servers, and swarm intelligence architecture.",
                icon: BookOpen,
              },
              {
                time: "11:00 AM - 02:00 PM",
                title: "Act II — Problem Announcement & Ideation",
                desc: "Release of the secret target metrics, API constraints, and live dataset challenges.",
                icon: Terminal,
              },
              {
                time: "02:00 PM - 06:00 PM",
                title: "Act III — Dev & Optimization Arena",
                desc: "Continuous building, testing against local benchmarks, and active leaderboard updates.",
                icon: Clock,
              },
              {
                time: "06:00 PM - 08:00 PM",
                title: "Act IV — Showcases & Evaluation",
                desc: "Final evaluation run, agent swarm telemetry review, and internship candidate interviews.",
                icon: ShieldCheck,
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="flex flex-col md:flex-row gap-4 p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-md hover:border-purple-500/30 transition-all duration-300"
              >
            ...
            {[
              {
                ...
                desc: "Orchestrate multi-agent systems to solve complex multi-step reasoning workflows with real-time feedback loops.",
                icon: Layers,
              },
              {
                title: "MCP Servers",
                desc: "Implement custom Model Context Protocol servers to link LLMs with external tools, systems, and local system environments.",
                icon: Terminal,
              },
              {
                title: "Autonomous Workflows",
                desc: "Build agent networks that automate full software pipelines, research pipelines, or code generation workflows.",
                icon: Calendar,
              },
            ].map((track, idx) => (
              <div
                key={idx}
                className="p-8 rounded-3xl border border-white/5 bg-white/[0.02] backdrop-blur-md hover:border-purple-500/35 hover:-translate-y-1 transition-all duration-300"
              >
            ...
            {[
              {
                ...
                desc: "Currently enrolled in any technical, mathematics, or computer science degree program. Perfect for displaying build telemetry.",
              },
              {
              ...
              },
              {
                ...
                desc: "Proficiency in Python/NodeJS, basic understanding of LLM prompt configuration, and server API integration.",
              },
            ].map((el, idx) => (
              <div
                key={idx}
                className="flex gap-4 p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-md hover:border-purple-500/20 transition-all duration-300"
              >
        ...
        <section id="prizes" className="scroll-mt-24">
          ...
          <div className="grid gap-6 md:grid-cols-3 max-w-5xl mx-auto">
            {[
              ...
              <div
                key={idx}
                className={`p-8 rounded-3xl border ${p.border} bg-white/[0.02] backdrop-blur-md hover:-translate-y-1 transition-all duration-300 text-center relative overflow-hidden`}
              >
        ...
        <section id="faqs" className="scroll-mt-24">
          ...
          <div className="grid gap-6 max-w-3xl mx-auto">
            {[
              {
                q: "Is AgentVerse 2.0 fully remote?",
                a: "Yes, the entire workshop and hacking session will be conducted online via Discord and Google Meet rooms. Evaluation runs are performed remotely.",
              },
              {
                q: "Can I enter if I have never built an LLM Agent?",
                a: "Absolutely. Act I includes a comprehensive architectural workshop covering the basics of MCP server implementation.",
              },
              {
                q: "What API keys will be provided?",
                a: "All participants will receive complimentary usage credits for leading LLM providers during the active hacking acts.",
              },
            ].map((faq, idx) => (
              <div
                key={idx}
                className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-md"
              >
        ...
        <section id="partners" className="scroll-mt-24">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {["Anthropic SDK Hub", "Llama Swarms", "MCP Spec Group", "Vercel AI"].map(
              (partner, idx) => (
                <div
                  key={idx}
                  className="p-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-md flex items-center justify-center hover:border-purple-500/20 transition-all duration-300"
                >
                  <span className="text-sm font-semibold text-purple-200/50 uppercase tracking-widest">
                    {partner}
                  </span>
                </div>
              ),
        ...
        <section id="contact" ref={footerRef} className="scroll-mt-24 text-center max-w-xl mx-auto">
          ...
          <p className="text-sm text-purple-200/60 mb-6 leading-relaxed">
            Reach out to our events coordination team for sponsor details, technical queries, or
