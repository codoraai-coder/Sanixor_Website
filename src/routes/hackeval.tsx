      ...
      <section className="relative flex min-h-screen flex-col items-center justify-center px-4 pt-28 pb-20 overflow-hidden">
        ...
        >
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/90 md:text-xl text-center">
            HackEval is an AI-powered multi-agent hackathon evaluation platform designed to automate
            project assessment, judging workflows, score aggregation, and result generation.
          </p>
            ...
            <div className="grid gap-10 md:grid-cols-2">
              ...
              >
                ...
                <p className="leading-relaxed text-lg text-muted-foreground">
                  Traditional hackathon evaluation processes are manual, time-consuming, and
                  inconsistent — leading to delayed results, human bias, and unfair assessments that
              ...
              >
                ...
                <p className="leading-relaxed text-lg text-muted-foreground">
                  HackEval leverages multi-agent AI to automate project evaluation across multiple
                  judging criteria, ensuring fairness, consistency, and scalability throughout the
