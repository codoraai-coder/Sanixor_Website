      ...
      >
        {OPTIONS.map((option, index) => (
          ...
          >
            ...
            <div
              className="absolute inset-0 bg-[#07030e] transition-opacity duration-700 ease-in-out"
            ...
            <div
              className="absolute inset-0 bg-black/40 transition-opacity duration-700 group-hover:bg-black/20"
              style={{ opacity: activeIndex === index ? 0.2 : 0 }}
            />
