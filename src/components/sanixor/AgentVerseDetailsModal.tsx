      ...
      <div className="av2-modal" onClick={(e) => e.stopPropagation()} data-lenis-prevent="true">
        ...
        >
          ...
          <p className="av2-sec-text">
            AgentVerse 1.0 lit a spark with 50+ builders. Now we are taking it to the next level. A
            purely online, high-stakes arena. With real pressure. Real competition. And a real
            problem that needs a real solution. Forget single-model AI. We are building ecosystems
            of specialized intelligent agents (Swarms) and MCP Servers.
          </p>
          ...
          >
            {[
              ...
              <div className="av2-detail-row" key={label} style={{ margin: 0, height: "100%" }}>
                ...
                <div>
                  <span className="av2-detail-label" style={{ color: "#fff" }}>
                    {label}
                  </span>
          ...
          <div style={{ display: "flex", gap: "24px", flexWrap: "wrap" }}>
            <div style={{ flex: "1 1 200px" }}>
              ...
              <p className="av2-sec-text">
                Students who want something real in their portfolio. Developers evolving from code
                to intelligence. Professionals refusing to be left behind.
              </p>
            </div>
            ...
            <div style={{ flex: "1 1 200px" }}>
              ...
              <p className="av2-sec-text">
                A working intelligent system you built yourself. Top 3 performers take home
                exclusive prizes.
                <span style={{ color: "#c4b5fd", fontWeight: 600 }}>
                  {" "}
                  One outstanding builder secures an internship.
                </span>
              </p>
            </div>
          </div>
